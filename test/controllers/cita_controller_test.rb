...
class CitaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post cita_url, params: { citum: { especialidad: @citum.especialidad, fecha: @citum.fecha, ips: @citum.ips, paciente: @citum.paciente, profesional: @citum.profesional } }
    end
  ...
  test "should update citum" do
    patch citum_url(@citum), params: { citum: { especialidad: @citum.especialidad, fecha: @citum.fecha, ips: @citum.ips, paciente: @citum.paciente, profesional: @citum.profesional } }
