...
class AgendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post agendas_url, params: { agenda: { especialidad: @agenda.especialidad, fecha: @agenda.fecha, ips: @agenda.ips, paciente: @agenda.paciente, profesional: @agenda.profesional } }
    end
  ...
  test "should update agenda" do
    patch agenda_url(@agenda), params: { agenda: { especialidad: @agenda.especialidad, fecha: @agenda.fecha, ips: @agenda.ips, paciente: @agenda.paciente, profesional: @agenda.profesional } }
